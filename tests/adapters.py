...
from cs336_basics.ffn import silu_activation, SwiGLU
...
def run_embedding(
    ...
    embedding.embedding.data = weights.clone()
...
def run_swiglu(
    ...
    swiglu.W1.W.data = w1_weight.clone()
    swiglu.W2.W.data = w2_weight.clone()
    swiglu.W3.W.data = w3_weight.clone()
...
def run_multihead_self_attention(
    ...
    cmhsa.W_qkv.W.data = torch.cat([q_proj_weight, k_proj_weight, v_proj_weight], dim=0)
    cmhsa.output_proj.W.data = o_proj_weight
...
def run_multihead_self_attention_with_rope(
    ...
    cmhsa.W_qkv.W.data = torch.cat([q_proj_weight, k_proj_weight, v_proj_weight], dim=0)
    cmhsa.output_proj.W.data = o_proj_weight
    return cmhsa(in_features, rope, token_positions)
...
def run_rmsnorm(
    ...
    rmsnorm.gain.data = weights.clone()
...
def run_get_lr_cosine_schedule(
    ...
    """
    return lr_cosine_schedule(t=it, alpha_min=min_learning_rate, alpha_max=max_learning_rate, t_w=warmup_iters, t_c=cosine_cycle_iters)
